...
ACTS = [
    ...
    },
    {
        ...
        "lines": [
            ...
            ("i212", "France still had a match left."),
            ("i213", "We didn't stay. We packed."),
            ("i214", "Mom said the final is soon."),
    ...
    {
        "name": "ACTE 9 - Avant la finale NYC",
        "pacing": "~3-4 sec/image",
        "images": "i219-i232",
        "duration": "~50 sec",
        "stadium": "Hors match - East Rutherford / NYC area",
        "match": "Avant finale - trajet vers MetLife (sans date)",
        "lines": [
            ("i219", "New York area."),
            ("i220", "East Rutherford. MetLife Stadium."),
            ("i221", "Spain versus Argentina. The final."),
            ("i222", "England one. Argentina two."),
            ("i223", "Mom said they have Messi. I said we have Lamine."),
    ...
    {
        "name": "ACTE 10 - La finale",
        "pacing": "~3-4 sec/image",
        "images": "i233-i258",
        "duration": "~1 min 30",
        "stadium": "MetLife Stadium (New York New Jersey Stadium), East Rutherford, USA",
        "match": "FINALE - Spain vs Argentina (sans score - publication avant match)",
        "lines": [
            ("i233", "Final day."),
            ("i234", "Spain versus Argentina. MetLife Stadium."),
            ("i235", "Eighty-two thousand seats. I had a ticket."),
            ...
            ("i246", "I knew he was looking for me."),
            ("i247", "The stadium went crazy."),
            ("i249", "Lamine didn't wave first."),
            ("i250", "He looked for me."),
            ("i251", "I was there."),
            ("i252", "Three years old. Almost four."),
            ("i253", "The World Cup changed everything."),
            ("i254", "Not for the team."),
            ("i255", "For me."),
...
MATCH_FACTS = [
    ...
    ("15 Jul", "England 1-2 Argentina", "Mercedes-Benz Stadium", "Atlanta, USA", "SF - Gordon 55', Enzo 85', Lautaro 90+2'"),
    ("19 Jul", "Spain vs Argentina", "MetLife Stadium", "East Rutherford, USA", "FINAL - score apres match"),
]
